...
def correct_title_case(title, always_lowercase, always_uppercase):
    ...
    Convert a title to Title Case (uppercase first letter of each word)
    and use best-guess logic to preserve lowercase and uppercase chars
    like articles (a, the) and roman numerals (I, IV, VIII). The first
    ...
    Returns:
        A Title Case string that accomodates some exceptions.
    """
