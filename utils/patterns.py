...
year = re.compile(r'\W+(?P<year>19[1-9]\d|20[0-9]\d|21[0-5]\d)') # Match year from 1910-2159, starting at the end of the filename
...
illegalChars = r'/?<>\:*|"' if (sys.platform == "win32") else r':' # Illegal OS chars